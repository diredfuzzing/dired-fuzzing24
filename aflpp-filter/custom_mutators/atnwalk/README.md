...
Refer to [https://github.com/atnwalk/testbed](https://github.com/atnwalk/testbed) for detailed instructions on how to
get ATNwalk running.
...
**NOTE:** The commands below just demonstrate an example how running ATNwalk looks like and require a
working [testbed](https://github.com/atnwalk/testbed)
